...
rem wdc816as.exe  -g -l -DUSING_816 -DLARGE -o UploadASM.obj Upload.asm
...
rem wdcln.exe -C20000,00000 -g -t -sz -HB -obin\Video.bin UploadASM.obj Heap.obj Image.obj Circle.obj Polygon.obj Random.obj Splatter.obj ColourTest.obj Main.obj GraphicsASM.obj StandardASM.obj -lcl -lml
wdcln.exe -C20000 -g -t -sz -HIE -obin\Video.hex Heap.obj Image.obj Circle.obj Polygon.obj Random.obj Splatter.obj ColourTest.obj Main.obj StartASM.obj GraphicsASM.obj StandardASM.obj -lcl -lml
