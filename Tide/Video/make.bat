...
wdc816as.exe  -g -l -DUSING_816 -DLARGE -o SpriteASM.obj Sprite.asm || exit /b
wdc816cc.exe  -bs -DUSING_816 -ml -wr -wu -so -sp -lt -pb -pp -px -o Heap.obj Heap.c || exit /b
wdc816cc.exe  -bs -DUSING_816 -ml -wr -wu -so -sp -lt -pb -pp -px -o ItoA.obj ItoA.c || exit /b
...
wdc816cc.exe  -bs -DUSING_816 -ml -wr -wu -lt -pb -pp -px -o MemoryDump.obj MemoryDump.c || exit /b
REM wdc816cc.exe  -bs -DUSING_816 -ml -wr -wu -so -sp -lt -pb -pp -px -o Main.obj MainCircles.c || exit /b
wdc816cc.exe  -bs -DUSING_816 -ml -wr -wu -so -sp -lt -pb -pp -px -o Main.obj MainSprites.c || exit /b
wdc816cc.exe  -bs -DUSING_816 -ml -wr -wu -so -sp -lt -pb -pp -px -o Sprite.obj Sprite.c || exit /b
wdc816cc.exe  -bs -DUSING_816 -ml -wr -wu -so -sp -lt -pb -pp -px -o Font5x7.obj Font5x7.c || exit /b
wdcln.exe -C20000,00000 -g -t -sz -HB -obin\VideoUpload.bin UploadASM.obj Heap.obj Image.obj ItoA.obj Circle.obj Polygon.obj Font.obj Random.obj Splatter.obj ColourTest.obj Font5x7.obj Sprite.obj MemoryDump.obj Main.obj GraphicsASM.obj StandardASM.obj FontASM.obj SpriteASM.obj -lcl -lml || exit /b
wdcln.exe -C20000 -g -t -sz -HIE -obin\VideoRom.hex Heap.obj Image.obj ItoA.obj Circle.obj Polygon.obj Font.obj Random.obj Splatter.obj ColourTest.obj Font5x7.obj Sprite.obj MemoryDump.obj Main.obj StartASM.obj GraphicsASM.obj StandardASM.obj FontASM.obj SpriteASM.obj -lcl -lml || exit /b
