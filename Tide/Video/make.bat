...
wdc816cc.exe  -bs -DUSING_816 -ml -wr -wu -lt -pb -pp -px -o Splatter.obj Splatter.c
wdc816cc.exe  -bs -DUSING_816 -ml -wr -wu -so -sp -lt -pb -pp -px -o Main.obj Main.c
wdcln.exe -C10000 -D20000 -g -t -sz -HIE -obin\Video.hex Heap.obj Image.obj Circle.obj Splatter.obj ColourTest.obj Main.obj StartASM.obj GraphicsASM.obj -lcl -lml
