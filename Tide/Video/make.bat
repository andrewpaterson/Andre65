...
wdcln.exe -C10000 -D20000 -g -t -sz -HIE -obin\Video.hex Heap.obj Image.obj Circle.obj Polygon.obj Random.obj Splatter.obj ColourTest.obj Main.obj StartASM.obj GraphicsASM.obj StandardASM.obj -lcl -lml
