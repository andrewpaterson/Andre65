...
;Total Stack used
_BlockMove_Parameters		EQU	_BlockMove_Scratch+3+4+4+2	;RTL address + D(4) + S(4) + n

;Parameter Direct Page offsets
_BlockMove_Bytes			EQU	_BlockMove_Scratch+3+4+4+1	;RTL address + D(4) + S(4) + 1 (+ 1 because low byte address first)
_BlockMove_Source			EQU	_BlockMove_Scratch+3+4+1	;RTL address + D(4) + 1 
