...
OPCODE		.EQU	PGZERO_ST+38	;Saved Opcode
;
...
SPARE_B0	.EQU	BIOS_PG0+31	;Spare BIOS page zero byte
;
;******************************************************************************
...
;
VECINSRT0	.EQU	SOFTVEC+16	;1st Vector Insert (Timer support)
VECINSRT1	.EQU	SOFTVEC+18	;1st Vector Insert (Timer support)
...
Via1PRB		.EQU  Via1Base+0	;Port B I/O register
Via1PRA		.EQU  Via1Base+1	;Port A I/O register
Via1DDRB	.EQU  Via1Base+2	;Port B data direction
Via1DDRA  .EQU  Via1Base+3	;Port A data direction
Via1T1CL  .EQU  Via1Base+4	;Timer 1 Low byte count
Via1T1CH  .EQU  Via1Base+5	;Timer 1 High byte count
Via1T1LL  .EQU  Via1Base+6	;Timer 1 Low byte latch
Via1TALH  .EQU  Via1Base+7	;Timer 1 High byte latch
Via1T2CL  .EQU  Via1Base+8	;Timer 2 Low byte count/latch
Via1T2CH  .EQU  Via1Base+9	;Timer 2 High byte count
Via1SR    .EQU  Via1Base+10	;Shift Register
Via1ACR   .EQU  Via1Base+11	;Aux control register
Via1PCR   .EQU  Via1Base+12	;Peripheral control register
Via1IFR   .EQU  Via1Base+13	;Interrupt flag register
Via1IER   .EQU  Via1Base+14	;Interrupt enable register
Via1PRA1  .EQU  Via1Base+15	;Port A echo register
;
;ACIA device address:
...
;
MONCMD		.DB $02 ;[CNTRL-B] Enter EhBasic
					.DB	$04	;[CNTRL-D]	Disassembler
...
;
MONTAB		.DW EHBASIC ;[CNTRL-B] $02 Start EhBasic
					.DW	DSSMBLR	;[CNTRL-D] $04	Disassembler
					.DW	XMODEM	;[CNTL-L]	$0C	Xmodem download, use send from terminal program
					...
					.DW	CPMVFL	; M	$4D	Copy a specified memory range to a specified target address
...
MSG_13		.DB	$0D,$0A
					...
					.DB $00
MSG_14		.DB $0D,$0A
					.DB "C02Monitor (c)2016 K.E.Maier",$07
MSG_15		.DB $0D,$0A
					.DB "Version 1.4"
					.DB $00
MSG_16		.DB $0D,$0A
...
MSG_26		.DB	$0D,$0A
					.DB	"RTC time error, check/reset!"
					.DB	$00
MSG_27		.DB	"XMODEM Loader, <Esc> to abort, or",$0D,$0A
...
HDLR_IDX	.DB	$26,$00,$33,$3E,$02,$10,$88,$8F
...
;
					.DW	WRM_MON	;NMI return handler in ROM
					.DW	WRM_MON	;BRK return handler in ROM
					.DW	IRQ_EXIT0	;IRQ return handler in ROM
;
					.DW	MONITOR	;Monitor Cold start
					.DW	WRM_MON	;Monitor Warm start
;
...
; Default for setup:		%00011111 ($1F) - 19.2K, 8 data, 1 stop)
					.DB	$1F	;Default 65C51 Control register, (115.2K,no parity,8 data bits,1 stop bit)
;
